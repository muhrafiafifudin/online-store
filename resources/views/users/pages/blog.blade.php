            ...
            <div class="entry-container" data-layout="fitRows">
                <div class="entry-item lifestyle shopping col-sm-6 col-lg-4">
                    <article class="entry entry-mask">
                        <figure class="entry-media">
                            <a href="single.html">
                                <img src="user/assets/images/blog/mask/grid/post-1.jpg" alt="image desc">
                            </a>
                ...
                <div class="entry-item lifestyle col-sm-6 col-lg-4">
                    <article class="entry entry-mask">
                        <figure class="entry-media entry-video">
                            <a href="single.html">
                                <img src="user/assets/images/blog/mask/grid/post-2.jpg" alt="image desc">
                            </a>
                        </figure><!-- End .entry-media -->
                ...
                <div class="entry-item lifestyle fashion col-sm-6 col-lg-4">
                    <article class="entry entry-mask">
                        <figure class="entry-media entry-gallery">
                            <a href="single.html">
                                <img src="user/assets/images/blog/mask/grid/post-3.jpg" alt="image desc">
                            </a>
                        </figure><!-- End .entry-media -->
                ...
                <div class="entry-item travel col-sm-6 col-lg-4">
                    <article class="entry entry-mask">
                        <figure class="entry-media">
                            <a href="single.html">
                                <img src="user/assets/images/blog/mask/grid/post-4.jpg" alt="image desc">
                            </a>
                        </figure><!-- End .entry-media -->
                ...
                <div class="entry-item travel hobbies col-sm-6 col-lg-4">
                    <article class="entry entry-mask">
                        <figure class="entry-media">
                            <a href="single.html">
                                <img src="user/assets/images/blog/mask/grid/post-5.jpg" alt="image desc">
                            </a>
                        </figure><!-- End .entry-media -->
                ...
                <div class="entry-item hobbies col-sm-6 col-lg-4">
                    <article class="entry entry-mask">
                        <figure class="entry-media">
                            <a href="single.html">
                                <img src="user/assets/images/blog/mask/grid/post-6.jpg" alt="image desc">
                            </a>
                        </figure><!-- End .entry-media -->
                ...
                <div class="entry-item travel col-sm-6 col-lg-4">
                    <article class="entry entry-mask">
                        <figure class="entry-media entry-gallery">
                            <a href="single.html">
                                <img src="user/assets/images/blog/mask/grid/post-7.jpg" alt="image desc">
                            </a>
                        </figure><!-- End .entry-media -->
                ...
                <div class="entry-item fashion col-sm-6 col-lg-4">
                    <article class="entry entry-mask">
                        <figure class="entry-media">
                            <a href="single.html">
                                <img src="user/assets/images/blog/mask/grid/post-8.jpg" alt="image desc">
                            </a>
                        </figure><!-- End .entry-media -->
                ...
                <div class="entry-item travel col-sm-6 col-lg-4">
                    <article class="entry entry-mask">
                        <figure class="entry-media">
                            <a href="single.html">
                                <img src="user/assets/images/blog/mask/grid/post-9.jpg" alt="image desc">
                            </a>
                        </figure><!-- End .entry-media -->
