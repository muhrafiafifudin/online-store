...
<div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
    ...
    <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
        ...
        <ul class="menu-nav">
            ...
            <li class="menu-item {{ (request()->is('admin/category', 'admin/product')) ? 'menu-item-active menu-item-open' : 'menu-item-submenu' }}" aria-haspopup="true" data-menu-toggle="hover">
            ...
            <li class="menu-item {{ (request()->is('admin/store')) ? 'menu-item-active' : '' }}" aria-haspopup="true" data-menu-toggle="hover">
                <a href="{{ route('admin.store.index') }}" class="menu-link menu-toggle">
                    ...
                    <span class="menu-text">Store Profile</span>
                </a>
            </li>
            ...
            <li class="menu-item {{ (request()->is('admin/transaction')) ? 'menu-item-active' : '' }}" aria-haspopup="true" data-menu-toggle="hover">
                <a href="{{ url('admin/transaction') }}" class="menu-link menu-toggle">
                    <span class="svg-icon menu-icon">
                        <!--begin::Svg Icon | path:assets/media/svg/icons/Layout/Layout-4-blocks.svg-->
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <li class="menu-item {{ (request()->is('admin/report-transaction')) ? 'menu-item-active' : '' }}" aria-haspopup="true" data-menu-toggle="hover">
                <a href="{{ url('admin/report-transaction') }}" class="menu-link menu-toggle">
                    <span class="svg-icon menu-icon">
                        <!--begin::Svg Icon | path:assets/media/svg/icons/Layout/Layout-4-blocks.svg-->
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <li class="menu-item mt-5" aria-haspopup="true">
